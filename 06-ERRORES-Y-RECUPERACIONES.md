...
**Estado consolidado al 11/08/2026 — cierre del Día 6**
...
| E-016 | POO/Java | Sintaxis Java escrita | **abierto** | Mantener práctica breve; constructor sigue requiriendo automatización |
...
| E-025 | Comunicaciones | PDU incompleta/confundida con PUD | **corregido** | PDU = Unidad de Datos de Protocolo = `SDU + PCI`; la sigla reapareció incorrecta |
...
| E-028 | Comunicaciones | Función de dispositivo atribuida a capa | **consolidado** | Switch procesa capa 2; router procesa capa 3; destino procesa toda la pila |
| E-029 | Comunicaciones | Unidad de switch/router omitida | **consolidado** | Switch → trama; Router → paquete/datagrama |
| E-030 | POO/Java | Constructor escrito como método `void` | **corregido** | Constructor = mismo nombre de clase y sin tipo de retorno, ni `void` |
...
| E-034 | Comunicaciones | Paquete vs. trama | **abierto** | Internet/Red → paquete; Acceso/Enlace → trama |
| E-035 | Comunicaciones | Bits vs. bytes en Física | **abierto** | Física transmite bits/señales como unidad del modelo |
...
1. **E-011 — Selección de estructura.** Aplicado a pila/lista; generalizar a otros problemas.
2. **E-012 — Alcance del modelo de datos.** Repetir en DER.
3. **E-018 — Estructura dinámica/tipo.** Repetir al estudiar más estructuras.
4. **E-025 — PDU.** La fórmula está comprendida; la expansión de la sigla volvió a fallar.
5. **E-026 — IP dentro/fuera de LAN.** Repetir al profundizar redes.
6. **E-030 — Constructor Java.** Repetir por escrito sin ayuda.

---

## Consolidaciones destacadas al Día 6
...
Pila = LIFO
push/pop/peek mantienen contrato aunque cambie la implementación
```
